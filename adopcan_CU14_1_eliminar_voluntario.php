...
if (!is_null($element)) {
    ...
    // Selecciono eliminar un Voluntarios.
    $element[4] = $webdriver->findElementBy(LocatorStrategy::xpath, "//*[@id='app']/article/section/div/div/div/div/section/div/table/tbody/tr[3]/td[6]/a[2]");
    // Hago click.   
    $element[4]->click();
    sleep(1);
